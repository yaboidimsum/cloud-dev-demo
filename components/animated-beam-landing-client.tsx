...
>(({ className, children }, ref) => {
  return (
    <div
      ref={ref}
      className={cn(
        "size-12 z-10 flex items-center justify-center rounded-full border-2 bg-white p-3 shadow-[0_0_20px_-12px_rgba(0,0,0,0.8)]",
        className
      )}
    >
      {children}
...
export default function AnimatedBeamDemo() {
  ...
  return (
    <div
      ...
      ref={containerRef}
    >
      <div className="size-full flex  max-w-lg flex-col items-stretch justify-between gap-10">
...
const Icons = {
  ...
  kumo: () => (
    ...
    >
      ...
      <path
        d="M150.575 171.912C151.054 167.106 156.556 164.62 160.479 167.438L275.225 249.863C279.148 252.681 278.549 258.689 274.147 260.677L145.393 318.837C140.991 320.826 136.087 317.303 136.566 312.497L150.575 171.912Z"
        fill="#FCFBFB"
      />
      <path
        d="M568.011 121.285C571.354 117.799 577.218 119.24 578.565 123.879L617.964 259.555C619.311 264.193 615.132 268.55 610.441 267.398L473.243 233.681C468.552 232.528 466.868 226.73 470.212 223.244L568.011 121.285Z"
        fill="#FCFBFB"
      />
      <ellipse
        cx="411.326"
        ...
        rx="338.084"
        ry="202.115"
        transform="rotate(-5.41619 411.326 412.918)"
        fill="white"
      />
      <path
        d="M276.077 363.922L344.328 378.981C353.3 380.961 354.41 393.305 345.935 396.853L282.232 423.53"
        stroke="black"
        strokeWidth="6.27451"
      />
      <path
        d="M357.646 487.844L386.754 516.952C397.455 527.653 415.619 523.882 421.175 509.805V509.805C426.732 495.727 444.895 491.956 455.597 502.658L456.838 503.899C467.932 514.992 486.721 511.374 492.901 496.954L503.528 472.158"
        stroke="black"
        strokeWidth="6.27451"
      />
      <ellipse
        ...
        rx="18.8235"
        ry="29.8039"
        transform="rotate(-7.57337 508.859 370.849)"
        fill="black"
      />
    </svg>
  ),
