    ...
    <div className="mx-auto max-w-4xl pt-8">
      <div className="mb-12 w-full">
        ...
        <div>
          ...
          <div className="mb-6 h-4 w-24 animate-pulse rounded bg-gray-200 dark:bg-gray-700" />
        </div>
        ...
        <div className="space-y-6">
          ...
          <div className="mb-12">
            <div className="mb-4 h-5 w-64 animate-pulse rounded bg-gray-200 dark:bg-gray-700" />

            <div className="flex flex-wrap gap-2">
              {/* GitHub button skeleton */}
              <div className="h-10 w-28 animate-pulse rounded-md bg-gray-200 dark:bg-gray-700" />
