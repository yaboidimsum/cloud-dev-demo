...
export default function DynamicDrawer() {
  ...
  return (
    ...
    >
      <button
        className={`${DynamicDrawerStyle.button} active:scale-85 ease w-fit scale-90 cursor-pointer bg-zinc-200/50 font-semibold duration-150`}
      ...
      >
        <div ref={ref} className={`${DynamicDrawerStyle.inner}`}>
          ...
          <motion.p>
            You found someone new this summer and I&apos;ve got the luck of a
            suicide bomber
          </motion.p>
          {showExtraContent ? (
