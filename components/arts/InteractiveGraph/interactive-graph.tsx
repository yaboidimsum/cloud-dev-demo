...
import { useSpring, motion, useMotionTemplate } from "framer-motion";
...
export default function Graph() {
  ...
  const clipPathValue = useSpring(0, hover ? SPRING : SLOW_SPRING);
  ...
  return (
    <div
      className={`${InteractiveGraphStyle.wrapper} m-8`}
