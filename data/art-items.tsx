...
const LazyClipPathButton = dynamic(() => import("@/components/arts/ClipPathButton/clip-path-button"));
const LazyDivClipPathButton = dynamic(() => import("@/components/arts/DivTransition/div-transition"));
const LazyTextReveal = dynamic(() => import("@/components/arts/TextReveal/text-reveal"));
const LazyCardPopHover = dynamic(() => import("@/components/arts/CardPopHover/card-pop-hover"));
const LazySmoothButton = dynamic(() => import("@/components/arts/BasicFramerButton/basic-framer-button"));
const LazyToaster = dynamic(() => import("@/components/arts/ToastPop/toast-pop"));
const LazyDynamicDrawer = dynamic(() => import("@/components/arts/DynamicDrawer/dynamic-drawer"));
const LazyFeedbackPopOver = dynamic(() => import("@/components/arts/FeedbackPopOver/feedback-pop-over"));
const LazyMultiStepCard = dynamic(() => import("@/components/arts/MultiStepCard/multi-step-card"));
const LazyInteractiveGraphAlt = dynamic(() => import("@/components/arts/InteractiveGraph/interactive-graph-alt"));
const LazyTrashAnimation = dynamic(() => import("@/components/arts/TrashAnimation/trash-animation"));
const LazyVaulDrawer = dynamic(() => import("@/components/arts/VaulDrawer/vaul-drawer"));
const LazyDynamicIsland = dynamic(() => import("@/components/arts/WavelengthBar/dynamic-island"));
const LazyFireField = dynamic(() => import("@/components/arts/FireField/fire-field"));
const LazyNavSearchBar = dynamic(() => import("@/components/arts/NavSearchBar/nav-search-bar"));
...
.button:active .holdOverlay {
  ...
  "text-reveal": {
    ...
    component: <LazyTextReveal text="tvcarchase94" placeholder="Animation" />,
...
@keyframes Fadein {
  ...
  "clip-path-transform": {
    ...
    component: <LazyDivClipPathButton text="Peek a Boo! 👻" variant="primary" />,
    tags: ["clip-path", "css"],
    publishedOn: "2025-09-23",
    explanation: (
      <div className="flex flex-col gap-8">
...
export default function MultiStepComponent() {
  ...
  "interactive-graph": {
    ...
    component: <LazyInteractiveGraphAlt />,
...
export { ART_ITEMS, type ArtItem, MINECRAFT_FIRE_PROMPT };
