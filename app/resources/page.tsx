...
const resources: Resource[] = [
  ...
  {
    title: "AI Agent UI (Beautiful UI)",
    description: "Crafted primitive components and aesthetic layout elements tailored for next-generation AI interfaces and AI agents.",
    url: "https://beautiful-ui-five.vercel.app/",
    category: "ui",
    tags: ["AI-Agent-UI", "Primitives", "TailwindCSS"],
    icon: SiFigma,
    color: "#E11D48",
  },
  {
  ...
  {
    title: "Gooey",
    description: "Jakub Antalík's fluid gooey blob filter effects and organic SVG liquid animation primitives.",
    url: "https://gooey.jakubantalik.com/",
    category: "ui",
    tags: ["SVG-Filter", "Gooey-Effect", "Liquid-FX"],
    icon: SiCss3,
    color: "#10B981",
  },
  {
