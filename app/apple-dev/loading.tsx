  ...
  return (
    <div className="mx-auto max-w-4xl pt-8">
      ...
      <div className="flex flex-col gap-2">
        <div className="mb-6 h-32 w-40 animate-pulse rounded bg-zinc-200 dark:bg-zinc-900" />
        <div className="mb-6 h-32 w-96 animate-pulse rounded bg-zinc-200 dark:bg-zinc-900" />
      </div>
